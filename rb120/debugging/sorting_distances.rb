...
class Length
  ...
  # By defining the #<=> method we enable the #sort method. But also, by
  # including the Comparable module in the class, we negate the necessity of 
  # defining all the other methods such as #==, #>, #<, etc.
